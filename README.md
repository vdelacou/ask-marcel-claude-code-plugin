...
scripts/           # gate scripts + thin CLI entries (console allowed here only): doctor, login, kb-init/seed, inbox-scan, voice-extract, read-mail, fetch-email-bundle, read-doc, search-exec, kb-queue, draft-preflight, draft-apply, write-kb-page, kb-lint, kb-index-gen, state, watermark, run-report, capture-signature, session-context
